...
public class SudokuEncoding {
   ...
   * @param sudoku the sudoku instance
   ...
   * @param base the base of the sudoku
   * @return the respective constraints as a set of clauses
   */
  private static Set<Clause> atLeastOneNumEachEntry(final int base) {
   ...
   * @return the respective constraints as a set of clauses
   */
  private static Set<Clause> eachNumAtMostOnceEachRow(final int base) {
    throw new ToBeImplementedException();
  }
  ...
  /**
   * Decodes a given variable mapping as sudoku instance. Variables are expected in the form `row`_`col`_`val`,
   * where row, col and val are Integer-parsable substrings.
   * @param model the variable mapping
   * @param base  the base of the sudoku
