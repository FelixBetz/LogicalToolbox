...
public abstract class Solver {
  ...
  /**
   * Tests if a given formula is satisfiable.
   * Note: If you have a proper implementation of {@link #isSAT(Set)} for clause sets,
   * it might be enough to call that method with the given formula transformed into a clause set.
  ...
  /**
   * Tests if a given clause set is satisfiable.
   * Note: If you have a proper implementation of {@link #isSAT(Formula)},
   * it might be enough to call that method with the given clause set transformed into a formula.
  ...
  /**
   * Returns a (potentially partial) mapping which satisfies the input. If the formula is unsatisfiable {@code null} is returned.
   * Note: If you have a proper implementation of {@link #getModel(Set)} for clause sets,
   * it might be enough to call that method with the given formula transformed into a clause set.
  ...
  /**
   * Returns a (potentially partial) mapping which satisfies the input. If the clause set is unsatisfiable {@code null} is returned.
   * Note: If you have a proper implementation of {@link #getModel(Formula)},
   * it might be enough to call that method with the given clause set transformed into a formula.
   * @param clauseSet the set of clauses
   * @return a satisfying variable mapping or {@code null} if none exists
   */
   ...
   * @param formula the formula to test
   * @return {@code true} if the formula is a contradiction, otherwise {@code false}
   */
   ...
   * @param f the first formula
   * @param g the second formula
   * @return {@code true} if the first formula entails the second formula (f => g), otherwise {@code false}
   */
   ...
   * @param f the first formula
   * @param g the second formula
   * @return {@code true} if the formulas are semantically equivalent (f <=> g), otherwise {@code false}
   */
