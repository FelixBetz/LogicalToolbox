 ...
 *
 * Each instance will allow only one call to parse, so you should create a new Parser for each file you want to parse.
 *
...
public final class DIMACSParser {
   ...
   * @throws IllegalStateException if {@link #parse(String)} has not been called before
   */
